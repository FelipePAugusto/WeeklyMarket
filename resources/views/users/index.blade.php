<html lang="en">
    ...
    <body class="clickup-chrome-ext_installed">
        <form id="logout-form" action="{{ url('/login/sair') }}" method="POST" style="display: none;">
            {{ csrf_field() }}
        </form>
        <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
            <div class="container-fluid">
                ...
                <a class="navbar-brand pt-0" href="{{ route('home') }}">
                    <img src="{{URL::asset('../resources/argon/img/brand/blue.png')}}" class="navbar-brand-img" alt="...">
                </a>
                <!-- User -->
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center">
                                ...
                                <img alt="Image placeholder" src="{{URL::asset('../resources/argon/img/theme/team-1-800x800.jpg')}}">
                                </span>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                            ...
                            <a href="{{ url('/login/sair') }}" class="dropdown-item" onclick="event.preventDefault();
                    ...
                    <ul class="navbar-nav align-items-center d-none d-md-flex">
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="{{URL::asset('../resources/argon/img/theme/team-4-800x800.jpg')}}">
                                    </span>
