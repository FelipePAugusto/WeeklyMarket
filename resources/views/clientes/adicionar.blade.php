                ...
                <div class="card card-profile shadow">
                        ...
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image" style="margin-top: 65px; margin-bottom: -35px;">
                                <a href="#">
                                    ...
                                    @if(isset($clientes) && $clientes->acao == "3")
                                        <img src="{{asset($clientes->imagem)}}" class="circle" onclick="document.getElementById('file').click();">
                                    @elseif(isset($clientes) && $clientes->acao == "2")
                                        <img src="{{asset($clientes->imagem)}}" class="circle" onclick="document.getElementById('file').click();">
                                    @else
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            @if(isset($clientes) && $clientes->acao == "3")
                                <form method="post" action="{{route('clientes.alterar_status', $clientes->id)}}" autocomplete="off" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                    ...
                    @if(isset($clientes) && $clientes->acao == "3")
                        <form method="post" action="{{route('clientes.alterar_imagem', $clientes->id)}}" autocomplete="off" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="_method" value="put">
                    ...
                    @elseif(isset($clientes) && $clientes->acao == "2")
                        <form method="get" action="{{route('clientes.listar')}}" autocomplete="off">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{route('clientes_salvar')}}" autocomplete="off">
                            {{ csrf_field() }}
                            <input type="file" style="display:none;" id="file" name="file" disabled/>
                ...
                <div class="card bg-secondary shadow" >
                    <div class="card-header bg-white border-0" >
                        <div class="row align-items-center col-8" style="margin-bottom: -10px">
                            @if(isset($clientes->nome) && $clientes->acao == "3")
                                <h2 class="mb-0" style="margin-top: -10px">Editar Cliente</h2>
                            @elseif(isset($clientes->nome) && $clientes->acao == "2")
                    ...
                    <div class="card-body" style="margin-top: -10px">
                        @if(isset($clientes->nome) && $clientes->acao == "3")
                        <form method="post" action="{{route('clientes.atualizar', $clientes->id)}}" autocomplete="off">
                            {{ csrf_field() }}
                            <input type="hidden" name="_method" value="put">
                        @elseif(isset($clientes) && $clientes->acao == "2")
                        <form method="get" action="{{route('clientes.listar')}}" autocomplete="off">
                        ...
                        @endif
                            ...
                            <div class="mb-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Nome" value="{{isset($clientes->nome) ? $clientes->nome : ''}}"  {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}} autofocus>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}" style="margin-top: -15px">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" value="{{isset($clientes->email) ? $clientes->email : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="cpf" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="____.____.____-__" value="{{isset($clientes->cpf) ? $clientes->cpf : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
                                    ...
                                    <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="celular" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="(XX) X XXXX - XXXX " value="{{isset($clientes->celular) ? $clientes->celular : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="endereco" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="Av. Marechal Floriano Peixoto" value="{{isset($clientes->endereco) ? $clientes->endereco : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="numero" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="XXXX" value="{{isset($clientes->numero) ? $clientes->numero : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="cep" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="________-___" value="{{isset($clientes->cep) ? $clientes->cep : ''}}" {{isset($clientes) && $clientes->acao == "2" ? 'disabled' : 'required'}}>
