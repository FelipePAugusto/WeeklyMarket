          ...
          <div class="card-header border-0" style="margin-bottom: -5px">
            <div class="row align-items-center" style="margin-top: -5px">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('feirantes_adicionar') }}" class="btn btn-sm btn-primary">Adicionar Feirante</a>
              </div>
            </div>
          </div>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    <a href="#" class="avatar rounded-circle mr-3">
                      <img alt="Image placeholder" src="{{asset($feirante->imagem)}}">
                    </a>
                    <div class="media-body">
                      <span class="nome mb-0 text-sm">{{ $feirante->nome }}</span>
                    </div>
                  </div>
                </th>
                <td class="email">
                ...
                <td>
                  <span class="badge badge-dot mr-4">
                    @if($feirante->status == "Analisando")
                      <i class="bg-warning"></i>
                      <span class="status text-warning mb-0 text-sm">{{ $feirante->status }}</span>
                    @elseif($feirante->status == "Bloqueado")
                      <i class="bg-danger"></i>
                      <span class="status text-danger mb-0 text-sm">{{ $feirante->status }}</span>
                    @else
                      <i class="bg-info"></i>
                      <span class="status text-info nome">{{ $feirante->status }}</span>
                    @endif
                  </span>
                </td>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <span class="endereco mr-2">{{ $feirante->endereco }}</span>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item" href="{{ route('feirantes.editar',$feirante->id) }}">Editar</a>
                      <a class="dropdown-item" href="{{ route('feirantes.visualizar',$feirante->id) }}">Visualizar</a>
                      <a class="dropdown-item" href="{{ route('feirantes.excluir',$feirante->id) }}">Excluir</a>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <ul class="pagination justify-content-end mb-0">
                <li class="page-item">
                  <a class="page-link" href="{{ $feirantes->previousPageUrl() }}" tabindex="-1" rel="prev">
                    <i class="fas fa-angle-left"></i>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                @for($i = 0; $i < $feirantes->lastPage(); $i++)
                <li class="page-item {{$feirantes->currentPage() == $i+1 ? 'active' : ''}}">
                  <a class="page-link" href="{{$feirantes->url($i+1)}}">{{$i+1}}</a>
                </li>
                @endfor
                {{-- Next Page Link --}}
                @if ($feirantes->hasMorePages())
                  <li class="page-item">
                    <a class="page-link" href="{{ $feirantes->nextPageUrl() }}" rel="next">
