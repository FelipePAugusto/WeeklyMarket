<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link href="../resources/argon/img/brand/favicon.png" rel="icon" type="image/png">
        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
        <!-- Icons -->
        <link href="../resources/argon/vendor/nucleo/css/nucleo.css" rel="stylesheet">
        <link href="../resources/argon/vendor/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
        <!-- Argon CSS -->
        <link type="text/css" href="../resources/argon/css/argon.css?v=1.0.0" rel="stylesheet">
    ...
    <body class="clickup-chrome-ext_installed">
                ...
                <ul class="nav align-items-center d-md-none">
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img alt="Image placeholder" src="../resources/argon/img/theme/team-1-800x800.jpg">
                            </span>
                            </div>
                        </a>
                        ...
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a  href="<?php echo e(url('/home')); ?>">
                                    <img src="../resources/argon/img/brand/blue.png">
                                </a>
                            </div>
        ...
        <script src="../resources/argon/vendor/jquery/dist/jquery.min.js"></script>
        <script src="../resources/argon/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>

        <!-- Argon JS -->
        <script src="../resources/argon/js/argon.js?v=1.0.0"></script>
    </body>
</html>
