<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.headers.cards', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            ...
                            <div class="col">
                                <ul class="nav nav-pills justify-content-end">
                                    ...
                                    <li class="nav-item mr-2 mr-md-0" data-toggle="chart" data-target="#chart-sales" data-update='{"data":{"datasets":[{"data":[0, 20, 10, 30, 15, 40, 20, 60, 60]}]}}' data-prefix="R$" data-suffix="0">
                                        <a href="<?php echo e(route('ordens.listar')); ?>" class="nav-link py-2 px-3 active" data-toggle="tab">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="<?php echo e(route('clientes.listar')); ?>" class="btn btn-sm btn-primary">Ver tudo</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow" >
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="<?php echo e(route('produtos.listar')); ?>" class="btn btn-sm btn-primary">Ver tudo</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
