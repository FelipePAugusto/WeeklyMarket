          ...
          <div class="card-header border-0" style="margin-bottom: -5px">
            <div class="row align-items-center" style="margin-top: -5px">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('produtos_adicionar')); ?>" class="btn btn-sm btn-primary">Adicionar Produto</a>
              </div>
            </div>
          </div>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    <a href="#" class="avatar rounded-circle mr-3">
                      <img alt="Image placeholder" src="<?php echo e(asset($produto->imagem)); ?>">
                    </a>
                    <div class="media-body">
                      <span class="nome mb-0 text-sm"><?php echo e($produto->nome); ?></span>
                    </div>
                  </div>
                </th>
                <td>
                    <span class="nome mb-0 text-sm"><?php echo e($produto->quantidade); ?> <?php echo e($produto->unidade_medida); ?></span>
                </td>
                <td>
                  <span class="nome mb-0 text-sm">R$ <?php echo e($produto->preco); ?></span>
                </td>
                <td>
                  <span class="badge badge-dot mr-4">
                    <?php if($produto->status == "Analisando"): ?>
                      <i class="bg-warning"></i>
                    <?php elseif($produto->status == "Bloqueado"): ?>
                      <i class="bg-danger"></i>
                    <?php else: ?>
                      <i class="bg-info"></i>
                    <?php endif; ?>
                    <span class="status"><?php echo e($produto->status); ?></span>
                  </span>
                </td>
                ...
                <td>
                    ...
                    <?php foreach($feirantes as $feirante): ?>
                      <?php if($produto->feirante_id == $feirante->id): ?>
                ...
                <td>
                  <span class="nome mb-0 text-sm"><?php echo e($produto->tipo); ?></span>
                </td>
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item" href="<?php echo e(route('produtos.editar',$produto->id)); ?>">Editar</a>
                      <a class="dropdown-item" href="<?php echo e(route('produtos.visualizar',$produto->id)); ?>">Visualizar</a>
                      <a class="dropdown-item" href="<?php echo e(route('produtos.excluir',$produto->id)); ?>">Excluir</a>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <ul class="pagination justify-content-end mb-0">
                <li class="page-item">
                  <a class="page-link" href="<?php echo e($produtos->previousPageUrl()); ?>" tabindex="-1" rel="prev">
                    <i class="fas fa-angle-left"></i>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                <?php for($i = 0; $i < $produtos->lastPage(); $i++): ?>
                <li class="page-item <?php echo e($produtos->currentPage() == $i+1 ? 'active' : ''); ?>">
                  <a class="page-link" href="<?php echo e($produtos->url($i+1)); ?>"><?php echo e($i+1); ?></a>
                </li>
                <?php endfor; ?>
                <?php /* Next Page Link */ ?>
                <?php if($produtos->hasMorePages()): ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo e($produtos->nextPageUrl()); ?>" rel="next">
