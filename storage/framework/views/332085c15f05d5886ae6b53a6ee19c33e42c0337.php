        ...
        <div class="card" style="margin-bottom: -1px">
          ...
          <div class="card-header border-0" style="margin-bottom: -5px">
            <div class="row align-items-center" style="margin-top: -5px">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('formas_pagamento_adicionar')); ?>" class="btn btn-sm btn-primary">Adicionar Forma de Pagamento</a>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table class="table align-items-center table-flush">
              ...
              <tr>
                <td>
                      <span class="nome mb-0 text-sm"><?php echo e($forma_pagamento->nome); ?></span>
                </td>
                <td>
                  <span class="badge badge-dot mr-4">
                    <?php if($forma_pagamento->status == "Analisando"): ?>
                      <i class="bg-warning"></i>
                    <?php elseif($forma_pagamento->status == "Bloqueado"): ?>
                      <i class="bg-danger"></i>
                    <?php else: ?>
                      <i class="bg-info"></i>
                    <?php endif; ?>
                    <span class="status"><?php echo e($forma_pagamento->status); ?></span>
                  </span>
                </td>
                <td class="descricao" style="margin-top: -20px">
                  <?php echo e($forma_pagamento->descricao); ?>

                </td>
                <td>
                    <span class="feirante mr-2">
                    <?php foreach($feirantes as $feirante): ?>
                      <?php if($forma_pagamento->feirante_id == $feirante->id): ?>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item" href="<?php echo e(route('formas_pagamento.editar',$forma_pagamento->id)); ?>">Editar</a>
                      <a class="dropdown-item" href="<?php echo e(route('formas_pagamento.visualizar',$forma_pagamento->id)); ?>">Visualizar</a>
                      <a class="dropdown-item" href="<?php echo e(route('formas_pagamento.excluir',$forma_pagamento->id)); ?>">Excluir</a>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <ul class="pagination justify-content-end mb-0">
                <li class="page-item">
                  <a class="page-link" href="<?php echo e($formas_pagamento->previousPageUrl()); ?>" tabindex="-1" rel="prev">
                    <i class="fas fa-angle-left"></i>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                <?php for($i = 0; $i < $formas_pagamento->lastPage(); $i++): ?>
                <li class="page-item <?php echo e($formas_pagamento->currentPage() == $i+1 ? 'active' : ''); ?>">
                  <a class="page-link" href="<?php echo e($formas_pagamento->url($i+1)); ?>"><?php echo e($i+1); ?></a>
                </li>
                <?php endfor; ?>
                <?php /* Next Page Link */ ?>
                <?php if($formas_pagamento->hasMorePages()): ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo e($formas_pagamento->nextPageUrl()); ?>" rel="next">
