...
<html>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(URL::asset('../resources/assets/img/brand/favicon.png')); ?>" type="image/png">
    <!-- Fonts -->
    ...
    <!-- <link type="text/css" href="<?php echo e(URL::asset('../resources/argon/css/argon.css?v=1.0.0')); ?>" rel="stylesheet"> -->
    ...
    <!-- Argon CSS -->
    <!-- Argon JS -->
    <script src="<?php echo e(URL::asset('../resources/argon/vendor/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>"></script>    <!-- Icons -->
    <link href="<?php echo e(URL::asset('../resources/argon/vendor/nucleo/css/nucleo.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::asset('../resources/argon/vendor/@fortawesome/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet">
    <script src="<?php echo e(URL::asset('../resources/argon/js/argon.js?v=1.0.0')); ?>"></script>
            ...
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="<?php echo e(url('/home')); ?>">
                  <img src="<?php echo e(URL::asset('../resources/argon/img/brand/blue.png')); ?>">
                </a>
              </div>
          ...
          <div class="card-header border-0" style="margin-bottom: -5px">
            <div class="row align-items-center" style="margin-top: -5px">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('clientes_adicionar')); ?>" class="btn btn-sm btn-primary">Adicionar Cliente</a>
              </div>
            </div>
          </div>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    <a href="#" class="avatar rounded-circle mr-3">
                      <img alt="Image placeholder" src="<?php echo e(asset($cliente->imagem)); ?>">
                    </a>
                    <div class="media-body">
                      <span class="nome mb-0 text-sm"><?php echo e($cliente->nome); ?></span>
                    </div>
                  </div>
                </th>
                <td class="email">
                ...
                <td>
                  <span class="badge badge-dot mr-4">
                    <?php if($cliente->status == "Analisando"): ?>
                      <i class="bg-warning"></i>
                    <?php elseif($cliente->status == "Bloqueado"): ?>
                      <i class="bg-danger"></i>
                    <?php else: ?>
                      <i class="bg-info"></i>
                    <?php endif; ?>
                    <span class="status"><?php echo e($cliente->status); ?></span>
                  </span>
                </td>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <span class="endereco mr-2"><?php echo e($cliente->endereco); ?></span>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item" href="<?php echo e(route('clientes.editar',$cliente->id)); ?>">Editar</a>
                      <a class="dropdown-item" href="<?php echo e(route('clientes.visualizar',$cliente->id)); ?>">Visualizar</a>
                      <a class="dropdown-item" href="<?php echo e(route('clientes.excluir',$cliente->id)); ?>">Excluir</a>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <ul class="pagination justify-content-end mb-0">
                <li class="page-item">
                  <a class="page-link" href="<?php echo e($clientes->previousPageUrl()); ?>" tabindex="-1" rel="prev">
                    <i class="fas fa-angle-left"></i>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                <?php for($i = 0; $i < $clientes->lastPage(); $i++): ?>
                <li class="page-item <?php echo e($clientes->currentPage() == $i+1 ? 'active' : ''); ?>">
                  <a class="page-link" href="<?php echo e($clientes->url($i+1)); ?>"><?php echo e($i+1); ?></a>
                </li>
                <?php endfor; ?>
                <?php /* Next Page Link */ ?>
                <?php if($clientes->hasMorePages()): ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo e($clientes->nextPageUrl()); ?>" rel="next">
