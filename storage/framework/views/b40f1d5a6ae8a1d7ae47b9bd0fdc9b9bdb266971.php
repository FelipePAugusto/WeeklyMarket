          ...
          <div class="card-header border-0" style="margin-bottom: -5px">
            <div class="row align-items-center" style="margin-top: -5px">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('feirantes_adicionar')); ?>" class="btn btn-sm btn-primary">Adicionar Feirante</a>
              </div>
            </div>
          </div>
                ...
                <th scope="row">
                  <div class="media align-items-center">
                    <a href="#" class="avatar rounded-circle mr-3">
                      <img alt="Image placeholder" src="<?php echo e(asset($feirante->imagem)); ?>">
                    </a>
                    <div class="media-body">
                      <span class="nome mb-0 text-sm"><?php echo e($feirante->nome); ?></span>
                    </div>
                  </div>
                </th>
                <td class="email">
                  <?php echo e($feirante->email); ?>

                </td>
                <td>
                  <span class="badge badge-dot mr-4">
                    <?php if($feirante->status == "Analisando"): ?>
                      <i class="bg-warning"></i>
                      <span class="status text-warning mb-0 text-sm"><?php echo e($feirante->status); ?></span>
                    <?php elseif($feirante->status == "Bloqueado"): ?>
                      <i class="bg-danger"></i>
                      <span class="status text-danger mb-0 text-sm"><?php echo e($feirante->status); ?></span>
                    <?php else: ?>
                      <i class="bg-info"></i>
                      <span class="status text-info nome"><?php echo e($feirante->status); ?></span>
                    <?php endif; ?>
                  </span>
                </td>
                <td class="status" style="margin-top: -20px">
                  <?php echo e($feirante->celular); ?>

                </td>
                <td>
                  <div class="d-flex align-items-center">
                    <span class="endereco mr-2"><?php echo e($feirante->endereco); ?></span>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item" href="<?php echo e(route('feirantes.editar',$feirante->id)); ?>">Editar</a>
                      <a class="dropdown-item" href="<?php echo e(route('feirantes.visualizar',$feirante->id)); ?>">Visualizar</a>
                      <a class="dropdown-item" href="<?php echo e(route('feirantes.excluir',$feirante->id)); ?>">Excluir</a>
                    </div>
                  </div>
                </td>
              </tr>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <ul class="pagination justify-content-end mb-0">
                <li class="page-item">
                  <a class="page-link" href="<?php echo e($feirantes->previousPageUrl()); ?>" tabindex="-1" rel="prev">
                    <i class="fas fa-angle-left"></i>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                <?php for($i = 0; $i < $feirantes->lastPage(); $i++): ?>
                <li class="page-item <?php echo e($feirantes->currentPage() == $i+1 ? 'active' : ''); ?>">
                  <a class="page-link" href="<?php echo e($feirantes->url($i+1)); ?>"><?php echo e($i+1); ?></a>
                </li>
                <?php endfor; ?>
                <?php /* Next Page Link */ ?>
                <?php if($feirantes->hasMorePages()): ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo e($feirantes->nextPageUrl()); ?>" rel="next">
